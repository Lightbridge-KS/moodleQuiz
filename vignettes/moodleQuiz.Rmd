...
Once you imported the report into `R`, do not format or clean any data prior to passing into the functions I will introduce to you next.
...
For example, this is the Grade report of `Quiz_1s`
